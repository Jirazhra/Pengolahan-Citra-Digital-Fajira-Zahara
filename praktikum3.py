...
def demonstrate_image_registration():
    """Demonstrate simple image registration"""
    ...
    axes[1].set_title("Moving Image (Transformed)")
    axes[1].axis("off")

    axes[2].imshow(registered_img, cmap='gray')
    axes[2].set_title("Registered Image (Aligned Back)")
    axes[2].axis("off")

    plt.suptitle("Image Registration Demonstration", fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.show()
